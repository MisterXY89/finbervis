...
class SentimentPredictor:
	...
	def __init__(self):
		...
		self.model_names = ["fine-tuned-model_full_apr.pt", "fine-tuned-model_drop_layer_8.pt", "fine-tuned-model_only_first_3.pt"]
		self.model = None
	...
	def load_model(self, model_num=0):
		"""
		...
		model_name = self.model_names[model_num]
		self.model = torch.load(f"{MODEL_DIR}/{model_name}", map_location=torch.device('cpu'))
		# self.model.eval()
