...
def cluster_one_hot(file, epsilon = 1.0, min_samples = 13, store = False):    
...
# cluster_one_hot("../data/data_copy.csv", epsilon = 3, min_samples = 25, store = True)
# cluster_one_hot("../data/drop_8_data.csv", epsilon = 3, min_samples = 25, store = True)